...
<img src="images/icon128.png" width="96" height="96" alt="おはツイKeeper logo">
...
<table>
<tr>
<th align="center">🪟 ポップアップ（メイン操作画面）</th>
<th align="center">⚙️ 設定ページ（オプション画面）</th>
</tr>
<tr>
<td valign="top">
...
```
┌──────────────────────────────────┐
│ ☀️ おはツイKeeper      [👤 user]  │ ← ヘッダー（アバター/ユーザー名）
├──────────────────────────────────┤
│  🔥12   📅348   💖2.1k   ⭐済み   │ ← 統計バー（4カラム）
├──────────────────────────────────┤
│ ┌──────────────────────────────┐ │
│ │ 𝕏 x.com/.../status/...  [登録済]│ │ ← ツイートカード
│ │ ツイート本文のプレビュー...     │ │
│ │ 🕐 2026-06-18  👤 @author      │ │
│ └──────────────────────────────┘ │
│                                    │
